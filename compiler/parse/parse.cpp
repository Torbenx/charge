...
after_expression$as_then:
    ...
    // SwitchState comma_after_expression_in_arguments
...
comma_after_expression_in_arguments$retry:
    ...
    case '\n': {
        tokEnd += 1;
        markLineBegin(tokEnd, output);
        goto comma_after_expression_in_arguments$retry;
    }
    case '\r': {
        if (tokEnd[1] == '\n') {
            tokEnd += 2;
    ...
    case '$':
    case '_':
        goto comma_after_expression_in_arguments$word_case_with_read;
    default: {
        VERIFY_NOT_REACHED();
    }
    } // switch
...
argument$as_then:
    ...
    case '_':
        ...
        emitToken(TokenKind::CallArgument, tokBegin, 0, output);
        // -> check_designated_argument
        goto check_designated_argument$word_case_with_read;
    default: {
        VERIFY_NOT_REACHED();
    }
    } // switch
...
LABEL_MAYBE_UNUSED check_designated_argument$word_case:
    ...
    // SwitchState maybe_designated_argument
...
maybe_designated_argument$retry:
    ...
    case '\n': {
        tokEnd += 1;
        markLineBegin(tokEnd, output);
        goto maybe_designated_argument$retry;
    }
    case '\r': {
        if (tokEnd[1] == '\n') {
            tokEnd += 2;
    ...
    // SwitchState first_argument_paren
...
first_argument_paren$retry:
    ...
    case '\n': {
        tokEnd += 1;
        markLineBegin(tokEnd, output);
        goto first_argument_paren$retry;
    }
    case '\r': {
        if (tokEnd[1] == '\n') {
            tokEnd += 2;
    ...
    // SwitchState first_argument_square
...
first_argument_square$retry:
    ...
    case '\n': {
        tokEnd += 1;
        markLineBegin(tokEnd, output);
        goto first_argument_square$retry;
    }
    case '\r': {
        if (tokEnd[1] == '\n') {
            tokEnd += 2;
    ...
    // SwitchState first_argument_brace
...
first_argument_brace$retry:
    ...
    case '\n': {
        tokEnd += 1;
        markLineBegin(tokEnd, output);
        goto first_argument_brace$retry;
    }
    case '\r': {
        if (tokEnd[1] == '\n') {
            tokEnd += 2;
...
variable_type$retry:
    ...
    case '$':
    case '_':
        goto variable_type$word_case_with_read;
    default: {
        VERIFY_NOT_REACHED();
    }
    } // switch
...
after_variable_modifier$as_then:
    ...
    case '\n': {
        tokEnd += 1;
        markLineBegin(tokEnd, output);
        goto after_variable_modifier$retry;
    }
    case '\r': {
        if (tokEnd[1] == '\n') {
            tokEnd += 2;
    ...
    // SwitchState after_variable_unique_modifier
...
after_variable_unique_modifier$retry:
    ...
    case '\n': {
        tokEnd += 1;
        markLineBegin(tokEnd, output);
        goto after_variable_unique_modifier$retry;
    }
    case '\r': {
        if (tokEnd[1] == '\n') {
            tokEnd += 2;
    ...
    case '$':
    case '_':
        goto after_variable_unique_modifier$word_case_with_read;
    default: {
        VERIFY_NOT_REACHED();
    }
    } // switch
...
after_variable_shared_modifier$retry:
    ...
    case '\n': {
        tokEnd += 1;
        markLineBegin(tokEnd, output);
        goto after_variable_shared_modifier$retry;
    }
    case '\r': {
        if (tokEnd[1] == '\n') {
            tokEnd += 2;
    ...
    case '$':
    case '_':
        goto after_variable_shared_modifier$word_case_with_read;
    default: {
        VERIFY_NOT_REACHED();
    }
    } // switch
...
after_variable_const_modifier$retry:
    ...
    case '\n': {
        tokEnd += 1;
        markLineBegin(tokEnd, output);
        goto after_variable_const_modifier$retry;
    }
    case '\r': {
        if (tokEnd[1] == '\n') {
            tokEnd += 2;
    ...
    case '$':
    case '_':
        goto after_variable_const_modifier$word_case_with_read;
    default: {
        VERIFY_NOT_REACHED();
    }
    } // switch
